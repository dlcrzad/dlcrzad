  ...
  return (
    <div className="portfolio-shell">
      ...
      <main className="portfolio-main">
        ...
        <section className="section-block content-section testimonial-section"><SectionHeading number="05" title="Kind words" link="Let&apos;s work" href="#contact" /><blockquote>“Adeline Dela Cruz is an outstanding Virtual Assistant who provided valuable support with web design, administrative tasks, and email management. Her attention to detail, creativity, and organizational skills greatly enhanced my productivity. Adeline consistently delivered quality work and handled multiple responsibilities. I highly recommend her to anyone seeking a reliable and skilled VA. She is a true professional and will be a tremendous asset to any team.”<cite>— Kellee, Founder of Prairie Giraffe<br />Technology advocate · Gillette, Wyoming</cite></blockquote></section>
